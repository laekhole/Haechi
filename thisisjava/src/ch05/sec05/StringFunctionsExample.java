...
public class StringFunctionsExample {
	...
	public static void main(String[] args) {
		...
		System.out.println("ssn에서 성은 "+(ssn.substring(index,index+1).equals("1")?"남자":"여자"));
		...
		//indexOf(패턴)의 결과값이 -1인 면 해당 패턴이 없는 것
		System.out.println("ssn에서 7이 있는지 여부 확인: "+(ssn.indexOf("7")>-1?"7이 포함":"7이 불포함"));
